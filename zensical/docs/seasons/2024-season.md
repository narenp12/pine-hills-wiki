...
```mermaid
flowchart LR
    S1["(1) Stroud Boys"] --> W1[Semifinal 1]
    S4["(4) Kaushal's Potatoes"] --> W1
    S2["(2) Jayesh's Great Team"] --> W2[Semifinal 2]
    S3["(3) varun’s victorious team"] --> W2
    W1 --> Champ["🏆 Champion"]
    W2 --> Champ
```
...
- [Seasons](index.md) · [2024 Draft](../draft/2024-draft.md) · [Teams](../teams/index.md) · [Records](../records/index.md) · <span class="wiki-new" title="This page has not been written yet">Lore</span> · [Playoffs](../playoffs.md)
